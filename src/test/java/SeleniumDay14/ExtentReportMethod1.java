...
public class ExtentReportMethod1 {
	...
	public void startReport() {
		...
		htmlReporter = new ExtentHtmlReporter(
				"./test-output/IBM_extentReport/IBM_ExtentReport_final" + dateName_number + ".html");
	...
	public void verifyLogo() {
		...
		// boolean img =
		// driver.findElement(By.xpath("//img[@id='hplogo']")).isDisplayed(); //true
