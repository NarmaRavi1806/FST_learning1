...
public class testData extends BaseClass {
	...
	public Object[][] smokeTestData() {
		...
		Object[][] data = { { "aasha@gmail.com", "welcome" }, { "ajay@google.com", "demo" },
				{ "imtiaz@yahoo.com", "demo123" } };
	...
	public Object[][] regressionTestData() {
		...
		Object[][] data = { { "aashaRegression@gmail.com", "welcome" }, { "ajayRegression@google.com", "demo" },
				{ "imtiazRegression@yahoo.com", "demo123" }, { "deepakRegression@yahoo.com", "demo123" } };
